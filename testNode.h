...
public:
   ...
   {  // setup
      ...
      assertUnit(Spy::numDefault() == 0);
      assertUnit(Spy::numNondefault() == 0);
      assertUnit(Spy::numCopyMove() == 1);   // move 99 over
      //    +----+
      //    | 99 |
      //    +----+
      assertUnit(n.data == Spy(99));
   ...
   {  // setup
      ...
      //    | 26 |
      //    +----+
      Node <Spy>* pSrc = new Node <Spy>;
      pSrc->data = Spy(26);
      pSrc->pPrev = pSrc->pNext = nullptr;
      Node <Spy>* pDes = nullptr;
      Spy::reset();
      // exercise
      pDes = copy(pSrc);
   ...
   {  // setup
      ...
      //    | 26 |
      //    +----+
      Node <Spy>* p26 = new Node <Spy>;
      p26->data = Spy(26);
      p26->pPrev = p26->pNext = nullptr;
      Spy::reset();
      // exercise
      clear(p26);
      // verify
   ...
   void teardownStandardFixture(Node <Spy>* pRoot)
   {
      if (nullptr != pRoot)
      {
         ...
         {
            if (nullptr != pRoot->pNext->pNext && pRoot->pNext->pNext != pRoot && pRoot->pNext->pNext != pRoot->pNext)
               delete pRoot->pNext->pNext;
            delete pRoot->pNext;
         }
         delete pRoot;
